...
SUPPLIER_LINK_CONFIG: dict[str, SupplierLink] = {
    ...
    "virgin-wines": SupplierLink(
        ...
        canonical_base_url="https://www.virginwines.co.uk/corporate-gifts",
        affiliate_url=None,
        fallback_url="https://www.virginwines.co.uk/corporate-gifting",
        category_tags=("wine", "wine-gifts", "corporate-gifting"),
    ),
    ...
    "waitrose-cellar": SupplierLink(
        ...
        canonical_base_url="https://www.waitrosecellar.com/shop/gifts",
        affiliate_url=None,
        fallback_url="https://www.waitrosecellar.com/shop/gifts/wine-gifts",
