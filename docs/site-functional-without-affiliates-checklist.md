...
- Supplier form/contact route checked: `/supplier-application` should collect supplier details and provide a `hello@clientcellar.co.uk` mailto fallback if submission fails.
- All public CTAs checked: buttons should navigate, submit a working form, open mailto, or be removed.
- Contact emails checked: general, supplier and commercial enquiries use `hello@clientcellar.co.uk`.
